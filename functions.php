...
if ( ! function_exists( 'superb_setup' ) ) {
	function superb_setup() {
		...
		add_image_size( 'post_feature_full_width', 657, 9999, true );
                
                
		// Create an extra image size for the Post thumbnail image
		add_image_size( 'post_feature_thumb', 228, 200, true );
...
function superb_scripts_styles() {
	...
	$fonts_url = 'http://fonts.googleapis.com/css?family=Pacifico|Ubuntu:400,300,700';
	if ( !empty( $fonts_url ) ) {
